          ...
          {allowedNavigation.map((item) => {
            ...
            return (
              <Link
                key={item.name}
                href={item.href}
                className={`flex items-center gap-3 rounded-lg text-m transition-all hover:text-primary text-white px-[15px] font-light leading-6 bg-sky-800 font-sans text-sm py-[5px] ${
      ...
      <div className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
        <div className="flex flex-col flex-grow bg-white border-r border-gray-200 pt-[15px] text-center">
          ...
          <div className="mt-8 flex-1 flex flex-col min-h-0">
            <nav className="flex-1 space-y-1 font-bold px-2.5 overflow-y-auto text-slate-400 bg-slate-100 py-2.5">
