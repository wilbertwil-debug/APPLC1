          ...
          {allowedNavigation.map((item) => {
            ...
            return (
              <Link
                key={item.name}
                href={item.href}
                className={`flex items-center gap-3 rounded-lg py-2 text-m transition-all hover:text-primary text-white px-[15px] font-light leading-6 bg-sky-800 font-sans text-lg ${
