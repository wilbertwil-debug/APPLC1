          ...
          {allowedNavigation.map((item) => {
            ...
            return (
              <Link
                key={item.name}
                href={item.href}
                className={`flex items-center gap-3 rounded-lg text-m transition-all hover:text-black text-white px-[15px] font-light leading-6 bg-sky-800 font-sans text-sm py-[5px] ${
